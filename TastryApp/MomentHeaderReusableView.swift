//
//  MomentHeaderReusableView.swift
//  TastryApp
//
...
class MomentHeaderReusableView: UICollectionReusableView {
  ...
  override func layoutSubviews() {
    ...
    if isInitialLayout {
      ...
      CCLog.verbose("Header Shadow Path Rect Width: \(addMomentButton.layer.bounds.width), Height: \(addMomentButton.layer.bounds.height)")
